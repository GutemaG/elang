...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.tap(find.byTooltip('Delete "Alphabet & Fidel"'));
      await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        _wrapped(packStore: packStore, syncEngine: engine),
      );
      await tester.pumpAndSettle();
  ...
  // other.
  testWidgets(
    'shows each pack under its course, legacy packs as English to Amharic',
    (tester) async {
      ...
      expect(find.textContaining('English to Amharic'), findsOneWidget);
      expect(find.textContaining('Amharic to Afaan Oromo'), findsOneWidget);
      expect(find.text('Alphabet & Fidel'), findsOneWidget);
